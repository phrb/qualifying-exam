...
\newcommand{\listabbreviationname}{\itshape \Large Lista de Abreviaturas}
...
% Setting custom lists
\newcommand{\listsymbolentryname}{\itshape \Large Lista de Símbolos}
...
\begin{center}
    ...
    financeiro do CNPq \textnumero XXXX}

    \vskip 0.5cm
    \normalsize{São Paulo, Junho de 2017}
\end{center}
...
\thispagestyle{empty}
    ...
    \begin{flushright}
    Esta é a versão original da qualificação elaborada pelo\\
    candidato Pedro Bruel, tal como \\
...
% Abstract
\chapter*{Abstract}
\noindent BRUEL, P. \textbf{Título do trabalho em inglês}.
2017. xxx f.
Qualificação (Doutorado) - Instituto de Matemática e Estatística,
Universidade de São Paulo, São Paulo, 2010.
\\
