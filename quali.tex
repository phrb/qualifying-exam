...
\fakesection{Autotuning GPU Compiler Parameters using OpenTuner}
\includepdf[pages={-}]{ape/bruel2015autotuning}

\fakesection{Autotuning CUDA Compiler Parameters for Heterogeneous Applications
using the OpenTuner Framework}
\includepdf[pages={-}]{ape/bruel2016autotuning_CCPE}

\fakesection{A New Program Autotuning Methodology Using Cloud Computing and
OpenTuner}
\includepdf[pages={-}]{ape/bruel2016protocol_submitted}

\fakesection{Autotuning High-Level Synthesis for FPGAs Using OpenTuner and
LegUp}
\includepdf[pages={-}]{ape/bruel2017autotuning}

\fakesection{Generalize or Die: Operating Systems Support for Memristor-based
Accelerators}
\includepdf[pages={-}]{ape/bruel2017generalize}

\fakesection{OpenMP is Not as Easy as It Appears}
\includepdf[pages={-}]{ape/goncalves2016openmp}

\fakesection{OpenMP or Pthreads: Which is Better for Beginners?}
\includepdf[pages={-}]{ape/bruel2017openmp}
